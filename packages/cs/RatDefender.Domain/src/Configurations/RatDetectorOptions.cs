...
public record RatDetectorOptions
{
    ...
    public float MinimumTemperatureCelsius { get; init; } = 27f;
    public float MaximumTemperatureCelsius { get; init; } = 45f;
    public bool UseThermalSensor { get; init; } = false;
    public uint? MinimumTimeBetweenDetectionsSeconds { get; init; } = 0;
